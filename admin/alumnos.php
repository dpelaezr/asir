...
?>
<h1 class="text-primary"><i class="fas fa-users"></i>  Alumnos</h1>
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
     <li class="breadcrumb-item" aria-current="page"><a href="index.php">Información </a></li>
     <li class="breadcrumb-item active" aria-current="page">Todos los alumnos</li>
  </ol>
</nav>
    ...
    ?>
      <tr>
        ...
        echo '<td>'.$i.'</td>
          ...
          <td>
            <a class="btn btn-xs btn-warning" href="index.php?page=editaralumno&id='.base64_encode($result['dni']).'&photo='.base64_encode($result['img']).'">
              <i class="fa fa-edit"></i></a>

             &nbsp; <a class="btn btn-xs btn-danger" onclick="javascript:confirmationDelete($(this));return false;" href="index.php?page=eliminar&dni='.base64_encode($result['dni']).'&img='.base64_encode($result['img']).'">
