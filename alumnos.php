...
?>
<h1 class="principal"><i class="fas fa-chalkboard-teacher"></i>  Alumnos</h1>
...
<table class="table  table-striped table-hover table-bordered" id="data">
  ...
  <tbody>
        ...
        <?php 
      $query=mysqli_query($dbconfig,'SELECT * FROM `alumnos` ORDER BY `alumnos`.`dni`;');
      $i=1;
        ...
        echo '<td>'.$i.'</td>
          ...
          <td>
            <a class="btn btn-xs" href="index.php?page=editaralumno&dni='.base64_encode($result['dni']).'&img='.base64_encode($result['img']).'">
             ...
             &nbsp; <a class="btn btn-xs" " href="index.php?page=eliminar&dni='.base64_encode($result['dni']).'&img='.base64_encode($result['img']).'">
